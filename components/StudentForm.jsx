...
function StudentForm({ setIsModalOpen, triggerRefresh }) {
        ...
        <>
            <form onSubmit={handleSubmit}>
                <div className="border-b border-gray-900/10 pb-8">
                    <p className="mt-1 text-sm leading-6 text-gray-600">Fill the below information to add a new student.</p>
                ...
                <button type='submit' className='py-2 px-4 rounded-md bg-gray-800 text-white mt-6 mr-3'>Create Student</button>
