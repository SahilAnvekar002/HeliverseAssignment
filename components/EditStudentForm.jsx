...
function EditStudentForm({setIsModalOpen, currentUser, triggerRefresh}) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="border-b border-gray-900/10 pb-8">
                <p className="mt-1 text-sm leading-6 text-gray-600">Edit the existing student information here.</p>
            ...
            <button type='submit' className='py-2 px-4 rounded-md bg-gray-800 text-white mt-6 mr-3'>Edit Student</button>
